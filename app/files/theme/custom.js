    ...
    $(document).ready(function() {
        ...
        function desc() {
            $(".wsite-product").each(function() {
                if (($(this).find(".wsite-product-image-image").outerHeight() <= $(this).children(".wsite-product-right").outerHeight()) && !$(this).hasClass("expanded") && $(this).has( "wsite-product-description" ).length) {
                    if (!$(this).children(".wsite-product-right").has(".close").length) {
                         $(this).children(".wsite-product-right").prepend('<a class="close" href="#">CLOSE</a>');
                         $(this).children(".wsite-product-right").append('<a class="more" href="#">MORE INFO</a>');
                    }
                    $(this).addClass("collapsed").removeClass("expanded");
                    $(this).children(".wsite-product-right").children(".more").fadeIn(300);
                }
                else if (($(this).find(".wsite-product-image-image").outerHeight() <= $(this).children(".wsite-product-right").outerHeight()) && !$(this).hasClass("expanded") && !$(this).has( "wsite-product-description" ).length) {
                  $(this).addClass('break');
                }
                else if ($(this).hasClass("collapsed") || $(this).hasClass("expanded")) {}
                else {
                    $(this).removeClass("collapsed").removeClass("break");
                    $(this).children(".wsite-product-right").children(".more, .close").remove();
                }
            });
        }
        ...
        $('#content').on('click', 'a.more', function(e) {
            e.preventDefault();
            var ht = $(this).parent().parent().outerHeight();
            $(this).parent().parent().addClass('expanded').removeClass('collapsed').css({"min-height" : ht+"px"});
            $(this).fadeOut(300);
        });
        ...
        $('#content').on('click', 'a.close', function(e) {
            ...
            $(this).parent().children(".more").delay(400).fadeIn(300);
            if ($(window).width() < 767) {
